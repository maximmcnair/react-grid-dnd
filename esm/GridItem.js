...
export function GridItem(_a) {
    ...
    var props = __assign(__assign(__assign({ className: (className ? className : 'GridItem') +
            (isDragging ? ' dragging' : '') +
            (!!disableDrag ? ' disabled' : '') }, bind), { style: __assign({ cursor: !!disableDrag ? "grab" : undefined, zIndex: styles.zIndex, position: "absolute", width: columnWidth + "px", opacity: styles.opacity, height: rowHeight + "px", boxSizing: "border-box", transform: interpolate([styles.xy, styles.scale], function (xy, s) {
