...
function GridDropZone(_a) {
    var id = _a.id, boxesPerRow = _a.boxesPerRow, boxAmount = _a.boxAmount, children = _a.children, style = _a.style, _b = _a.disableDrag, disableDrag = _b === void 0 ? false : _b, _c = _a.disableDrop, disableDrop = _c === void 0 ? false : _c, rowHeight = _a.rowHeight, onDragStart = _a.onDragStart, onDragEnd = _a.onDragEnd, other = tslib.__rest(_a, ["id", "boxesPerRow", "boxAmount", "children", "style", "disableDrag", "disableDrop", "rowHeight", "onDragStart", "onDragEnd"]);
    ...
    //
    return (React.createElement("div", tslib.__assign({ ref: ref, style: tslib.__assign(tslib.__assign({ position: "relative" }, style), { 
...
function GridItem(_a) {
    var children = _a.children, style = _a.style, className = _a.className, other = tslib.__rest(_a, ["children", "style", "className"]);
    ...
    var props = tslib.__assign(tslib.__assign(tslib.__assign({ className: (className ? className : 'GridItem') +
            (isDragging ? ' dragging' : '') +
            (!!disableDrag ? ' disabled' : '') }, bind), { style: tslib.__assign({ cursor: !!disableDrag ? "grab" : undefined, zIndex: styles.zIndex, position: "absolute", width: columnWidth + "px", opacity: styles.opacity, height: rowHeight + "px", boxSizing: "border-box", transform: reactSpring.interpolate([styles.xy, styles.scale], function (xy, s) {
